...
describe('shallowequal', function() {
    ...
    it('should set the `this` binding', ()=>{
        const actual = shallowEqual('a', 'b', function compare(a, b) {
    ...
    it('should not handle comparisons if `customizer` returns `true`', ()=>{
        const customizer = (value)=>typeof value === 'string' || undefined
        ;
    ...
    it('should not handle comparisons if `customizer` returns `false`', ()=>{
        const customizer = (value)=>typeof value === 'string' ? false : undefined
        ;
    ...
    it('should return a boolean value even if `customizer` does not', ()=>{
        const actual = shallowEqual('a', 'b', ()=>'c'
        );
        expect(actual).toEqual(true);
        ...
        values.forEach((value)=>{
            result.push(shallowEqual('a', 'a', ()=>value
            ));
        });
...
//# sourceMappingURL=shallowEqual.spec.js.map